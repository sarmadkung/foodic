...
import { View, Text, StyleSheet, FlatList, TextInput, Image, TouchableOpacity, Alert, ImageSourcePropType } from 'react-native';
...
export const Category: React.FC<CategoryScreenProps> = ({ categories, popularItems }) => {
        ...
        renderItem={({ item }) => (
          ...
          >
            <TouchableOpacity onPress={() => handlePopularItemPress(item)}>
              <Image alt='img' source={item.image } style={styles.popularItemImage} />
          ...
          <TouchableOpacity onPress={() => handleCategoryPress(item)}>
            <RectButton style={styles.categoryItem}>
              <MotiView
                ...
                transition={{ type: 'timing', duration: 500 }}
              >
                <Image alt='img' source={ item.image } style={styles.categoryItemImage} />
              </MotiView>
